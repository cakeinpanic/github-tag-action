...
function compareCommits(baseRef, headRef) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        commits.data.commits.filter(({ sha }) => __awaiter(this, void 0, void 0, function* () {
            const c = yield octokit.git.getCommit(Object.assign(Object.assign({}, github_1.context.repo), { commit_sha: sha }));
